...
function ContactUs() {
  return (
    <div>
      <div className=" flex pt-28 w-full justify-center mb-14">
        <div className=" w-[85%] rounded-2xl flex flex-col items-center">
          ...
          <div className=" bg-white flex items-center mb-16 p-10">
            ...
            <div className="violet_glass h-[457px] w-[350px] relative overflow-hidden mb-6 rounded-xl p-4  ">
              ...
              <div className="flex  absolute bottom-14 space-x-2">
                <Link
                  href={
                    "https://www.facebook.com/profile.php?id=61566453275005"
                  }
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <Link
                  href={"https://youtube.com/@sconsultancy?si=-skADh8ppJY3Kq-4"}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
