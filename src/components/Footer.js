        ...
        <div className="flex flex-col justify-center ">
          ...
          <div className=" mt-3 pl-4 flex  justify-between bg-[#2A2F39] rounded-full  ">
            <input
              ...
              className=" bg-black bg-opacity-0 w-[18rem]  outline-none  font-semibold text-white text-opacity-40 py-4"
            />
            <button className=" bg-[#615FEB] text-white rounded-full w-[149px] h-full text-sm ">
              Getting Started
            </button>
          </div>
        </div>
